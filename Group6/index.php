...
<body>
   ...
   <div class="modal fade" id="login-modal" tabindex="-1" aria-labelledby="login-modalLabel" aria-hidden="true">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="username" class="form-control" id="login-username" required maxlength="12">
        </div>
        <div class="mb-3">
            <label for="login-password" class="col-form-label">Password:</label>
            <input type="password" name="password" class="form-control" id="login-password" required maxlength="15">
        </div>
                        <script>
